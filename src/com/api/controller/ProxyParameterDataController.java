...
@Controller
public class ProxyParameterDataController {
	
	@RequestMapping(value="/data/weather/para",method=RequestMethod.POST,produces="text/html;charset=UTF-8")
	@ResponseBody
	public String getWeatherJSON(@RequestParam (value="accesstoken", defaultValue="") String accesstoken,@RequestParam (value="method", defaultValue="") String method,@RequestParam (value="apid", defaultValue="") String apid) {
